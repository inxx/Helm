...
const messages: Record<AppLanguage, Record<MessageKey, string>> = {
  en: {
    ...
    "sessions.introMessage": "Continue giving instructions below. The orchestrator routes work to workers, and each worker's result is summarized in this thread.",
    ...
    "sessions.emptyChat.description": "Send a task instruction. The orchestrator hands it to workers and summarizes their progress here.",
  },
  ko: {
    "nav.chat": "대화",
    "nav.tasks": "보드",
    ...
    "sessions.introMessage": "작업 지시는 아래 입력으로 이어서 받습니다. 오케스트레이터가 작업자에게 일을 넘기고, 각 작업자의 결과는 이 스레드에 요약으로 누적됩니다.",
    ...
    "sessions.emptyChat.description": "작업 지시를 보내세요. 오케스트레이터가 작업자에게 넘기고 진행 상황을 여기에 요약합니다.",
  },
};
